...
<head>
    ...
    <style>
        ...
        .error { background: #f8d7da; color: #721c24; padding: 10px; border-radius: 4px; text-align: center; margin-bottom: 20px; font-size: 14px; }
...
<div class="login-box">
    ...
    <form action="login.php" method="POST">
        ...
        <input type="text" name="username" placeholder="Weka Username (Robby)" required>
        
        <label>Password</label>
        <input type="password" name="password" placeholder="Weka Password (12345)" required>
